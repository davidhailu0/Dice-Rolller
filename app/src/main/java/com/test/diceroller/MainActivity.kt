...
import com.test.diceroller.ui.theme.DiceRollerTheme
...
fun DiceWithButtonImage(modifier: Modifier = Modifier){
    ...
    Surface {
        Column(verticalArrangement = Arrangement.SpaceBetween, horizontalAlignment = Alignment.CenterHorizontally,modifier = modifier) {
            ...
            Image(painter = imageResource,contentDescription = "Dice Image",modifier = Modifier.weight(1f))
            Button(onClick = { result = (1..6).random()  }, modifier = Modifier.padding(100.dp)) {
